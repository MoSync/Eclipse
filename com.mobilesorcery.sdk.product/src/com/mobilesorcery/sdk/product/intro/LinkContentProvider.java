...
public abstract class LinkContentProvider implements IIntroXHTMLContentProvider {
	...
	protected void createActionLink(String actionClass, String href, String linkText, Element parent, int breaks) {		
		Element link = parent.getOwnerDocument().createElement("a");
		link.setAttribute("class", "content-link");
		link.setAttribute("href", 
				MessageFormat.format("http://org.eclipse.ui.intro/runAction?" +
						"class={0}&" +
	...
	protected void createMoreLink(String moreText, String morePage, Element parent) {		
		createLink(MessageFormat.format("http://org.eclipse.ui.intro/showPage?id={0}", morePage), moreText, parent);
	}
	
	protected void createHelpLink(String helpText, String helpPage, Element parent) {
		createLink(MessageFormat.format("http://org.eclipse.ui.intro/showHelpTopic?id={0}", helpPage), helpText, parent);
	}
